...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 12, 2020 at 08:38 PM
...
(261, '9', 'PDP', 500, 'muna', '0000-00-00 00:00:00', '127.0.0.1.101'),
(262, '9', 'PDP', 500, 'muna', '0000-00-00 00:00:00', '127.0.0.1.101'),
(263, '9', 'PDP', 100, 'muna', '0000-00-00 00:00:00', '127.0.0.1.101'),
(264, '9', 'PDP', 100, 'muna', '0000-00-00 00:00:00', '127.0.0.1.101'),
(265, '9', 'PDP', 100, 'muna', '0000-00-00 00:00:00', '127.0.0.1.101'),
(266, '8', 'PDP', 500, 'tobi', '0000-00-00 00:00:00', '127.0.0.1.101');
...
--
-- Table structure for table `projectpollling`
--

CREATE TABLE `projectpollling` (
  `result_id` int(11) NOT NULL,
  `polling_unit_uniqueid` varchar(50) NOT NULL,
  `party_abbreviation` char(4) DEFAULT NULL,
  `party_score` int(11) DEFAULT NULL,
  `entered_by_user` varchar(50) DEFAULT NULL,
  `user_ip_address` varchar(50) DEFAULT NULL,
...
--
-- Dumping data for table `projectpollling`
--

INSERT INTO `projectpollling` (`result_id`, `polling_unit_uniqueid`, `party_abbreviation`, `party_score`, `entered_by_user`, `user_ip_address`, `date_entered`) VALUES
(1, '8', 'PDP', 500, 'muna', '127.0.0.1.101', '2020-11-12 13:17:24'),
(2, '8', 'PDP', 600, 'muna', '127.0.0.1.101', '2020-11-12 13:19:14'),
(3, '9', 'APP', 400, 'kona', '127.0.0.1.101', '2020-11-12 13:23:40');
...
--
-- Indexes for table `projectpollling`
--
ALTER TABLE `projectpollling`
  ADD PRIMARY KEY (`result_id`);
...
--
-- AUTO_INCREMENT for table `projectpollling`
--
ALTER TABLE `projectpollling`
